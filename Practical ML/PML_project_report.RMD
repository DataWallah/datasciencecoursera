...
In the code below I have used the eval=FALSE option so as to suppress evaluation, as it takes a long time and I have already run the analyses. I have also copied/pasted results from the R console output so the formatting is not ideal.
...
mtry  Accuracy  Kappa  Accuracy SD  Kappa SD  
  2     0.284     0      0.000109     0         
  117   0.805     0.751  0.0146       0.0187    
  6860  0.959     0.948  0.00795      0.01      
